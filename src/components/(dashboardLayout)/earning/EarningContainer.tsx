  ...
  return (
    <div>
      <div className="flex items-center py-4 gap-10">
        <h1 className="text-2xl font-bold text-primaryWhite">Earnings</h1>
        <>
          <div className="flex items-center gap-x-6 p-3 bg-primaryOrange rounded-lg text-white">
        ...
        <>
          <div className="flex items-center gap-x-3 p-3 bg-primaryOrange rounded-lg text-white">
            <FaArrowRightArrowLeft size={20} color="white" />
